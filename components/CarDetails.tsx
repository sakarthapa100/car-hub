...
<div className='flex gap-3'>
  ...
  <Image
          src={generateCarImageUrl(car,'50')}
          alt="car model"
          fill
          priority
          className="object-contain"
  ...
  <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
  <Image
          src={generateCarImageUrl(car,'52')}
          alt="car model"
          fill
          priority
          className="object-contain"
...
{Object.entries(car).map(([key, value]) => (
  <div
    className='flex justify-between gap-5 w-full text-right font-semibold capitalize'
    key={key}
  >
    <h4 className='text-black-100'>{key.split("_").join(" ")}</h4>
